...
public class MeasureToViewMapTest {
  ...
  @Test
  public void testRegisterAndGetDistributionViewData() {
    MeasureToViewMap measureToViewDataMap =
        new MeasureToViewMap();
    TestClock clock = TestClock.create(Timestamp.create(10, 20));
    measureToViewDataMap.registerView(VIEW, clock);
    clock.setTime(Timestamp.create(30, 40));
    ViewData actual = measureToViewDataMap.getView(VIEW_NAME, clock);
    actual.match(
