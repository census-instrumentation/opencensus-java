 ...
 *     = ElasticsearchConfiguration.builder().setAppName("sample-app")
 *             .setElasticsearchUrl("http://localhost:9200)
 *             .setElasticsearchIndex("index").setElasticsearchType("type").build();
...
public class ElasticsearchTraceExporter {
  ...
  public static void createAndRegister(ElasticsearchConfiguration elasticsearchConfiguration)
    ...
    synchronized (monitor) {
      ...
      handler = new ElasticsearchTraceHandler(elasticsearchConfiguration);
